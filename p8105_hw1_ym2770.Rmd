...
This dataset includes data of location and physical physical features of 3 species of penguins. Important variables include species, island where the penguin is from, bill length and depth in mm, flipper length in mm, body mass in gram, sex, and year. 3 penguins species include Adelie, Chinstrap and Gentoo. 3 islands that these penguins are from include Biscoe, Dream, and Torgersen.
